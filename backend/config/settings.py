...
CHATBOT_USE_AGENT = os.getenv("CHATBOT_USE_AGENT", "False") == "True"
CHATBOT_AGENT_MAX_ITERATIONS = int(os.getenv("CHATBOT_AGENT_MAX_ITERATIONS", "5"))
...
CHATBOT_RETRIEVAL_MAX_CHUNKS = int(os.getenv("CHATBOT_RETRIEVAL_MAX_CHUNKS", "4"))
CHATBOT_RETRIEVAL_MAX_CONTEXT_CHARS = int(os.getenv("CHATBOT_RETRIEVAL_MAX_CONTEXT_CHARS", "2800"))
CHATBOT_RETRIEVAL_RELOAD_SECONDS = int(os.getenv("CHATBOT_RETRIEVAL_RELOAD_SECONDS", "30"))
CHATBOT_RETRIEVAL_DEBUG_PRINT = os.getenv("CHATBOT_RETRIEVAL_DEBUG_PRINT", "false").lower() == "true"

# Embedding provider config (for hybrid/embeddings mode)
CHATBOT_EMBEDDING_PROVIDER = os.getenv("CHATBOT_EMBEDDING_PROVIDER", "none")
CHATBOT_EMBEDDING_MODEL = os.getenv("CHATBOT_EMBEDDING_MODEL", "text-embedding-3-small")
CHATBOT_AZURE_EMBEDDING_DEPLOYMENT = os.getenv("CHATBOT_AZURE_EMBEDDING_DEPLOYMENT", "")
